...
import heroSurveillance from "@/assets/svc-surveillance.jpg";
import survIpCctv from "@/assets/surv/surv-ip-cctv.jpg";
import survAnalog from "@/assets/surv/surv-analog-coax.jpg";
import survPtz from "@/assets/surv/surv-ptz.jpg";
import survVms from "@/assets/surv/surv-vms.jpg";
import survAi from "@/assets/surv/surv-ai-analytics.jpg";
...
export const Route = createFileRoute("/services/surveillance-system")({
  head: () => ({
    meta: [
      { title: "Surveillance System in Saudi Arabia — Roya Ventures" },
      {
        name: "description",
        content:
          "Surveillance company in Saudi Arabia — IP CCTV, HD-over-Coax, PTZ and thermal cameras, VMS platforms and AI video analytics installed by certified engineers.",
      },
...
const OFFERINGS = [
  {
    icon: Cctv,
    title: "IP CCTV Camera Systems",
    text: "We design IP camera networks that cover every zone with the right resolution, frame rate, and field of view for each location.",
    image: survIpCctv,
  },
  {
    icon: Cable,
    title: "Analog & HD Over Coax Systems",
    text: "We work with HD-over-Coax technology that delivers high-definition footage over existing analog infrastructure.",
    image: survAnalog,
  },
  {
    icon: ScanEye,
    title: "PTZ & Specialised Cameras",
    text: "We deploy PTZ (pan-tilt-zoom) cameras for wide-area monitoring, thermal cameras for perimeter detection in low light, and licence plate recognition cameras for vehicle access points.",
    image: survPtz,
  },
  {
    icon: MonitorPlay,
    title: "Video Management Software (VMS)",
    text: "We configure VMS platforms that bring all your cameras into one interface.",
    image: survVms,
  },
  {
    icon: BrainCircuit,
    title: "AI & Analytics-Enabled Surveillance",
    text: "We deploy cameras and VMS platforms with built-in analytics, people counting, line crossing alerts, and facial recognition integration.",
    image: survAi,
  },
  {
    icon: Fence,
    title: "Perimeter & Outdoor Surveillance",
    text: "We select and position outdoor cameras specifically for the conditions with IR night vision, weatherproofing, and wide dynamic range.",
    image: survPerimeter,
  },
  {
    icon: Smartphone,
    title: "Remote Monitoring & Live Viewing",
    text: "We configure secure remote access so authorised personnel can view live and recorded footage from anywhere.",
    image: survRemote,
  },
];
...
const PROCESS: [string, string][] = [
  [
    ...
    "We walk your site, map your risk zones, and identify every area that needs coverage.",
  ],
  [
    "Camera Layout Design",
    "Our engineers produce a detailed camera placement plan, with every camera positioned, angled, and specified.",
  ],
  [
    "Equipment Selection",
    "We recommend cameras, recorders, and VMS platforms based on your environment and requirements.",
  ],
  [
    "Install and Configure",
    "Our certified engineers handle the full installation and check that every camera is configured. We test remote access, storage capacity, alert triggers, and VMS workflows before we hand anything over.",
  ],
  ["We Stay Available", "We offer 24/7 full support and track performance."],
  [
    "We Train Your Team",
    "We train your facilities and security teams on daily operation, reporting, and how to respond to alerts.",
  ],
];
...
const FAQS: [string, string][] = [
  [
    "Can you upgrade our existing system without replacing everything?",
    "Yes. HD-over-Coax technology lets us deliver high-definition footage over existing analog cabling.",
  ],
  [
    "Do your surveillance systems integrate with access control?",
    "Yes. We design surveillance and access control as an integrated system.",
  ],
  [
    "How long can footage be stored?",
    "We size storage to your requirement, whether that's 14 days, 30 days, 90 days, or longer.",
  ],
  [
    "How do I know how many cameras I need?",
    "That depends on your site, your risk areas, and the coverage you need. We conduct a proper site survey and produce a camera layout plan before recommending quantities.",
  ],
  [
...
function SurveillancePage() {
  ...
  return (
    <SiteLayout transparentHeader>
      <PageHero
        eyebrow="Surveillance & AI video analytics"
        title={
          <>
            Surveillance System in <span className="text-[var(--gold)]">Saudi Arabia</span>
          </>
        }
        subtitle="As a leading Surveillance company in Saudi Arabia, we've been helping businesses with advanced CCTV and security systems."
        image={heroSurveillance}
        height="compact"
      >
        <Link to="/contact" className="btn-primary btn-on-dark">
          Get a Free Surveillance Assessment <ArrowRight className="h-4 w-4" />
        </Link>
        ...
        <div className="container-px mx-auto">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 items-start">
            <Reveal>
              ...
              <h2 className="heading-sub-lg mt-6">Advanced Surveillance System Overview</h2>
      ...
      <section className="section-y bg-[var(--stone)] relative overflow-hidden">
        ...
        <div className="container-px mx-auto relative">
          <SectionHeading
            ...
            title={<>What We Offer</>}
            description="We deploy from IP camera networks to AI-assisted video analytics, we work with the latest surveillance technologies."
          />
          ...
          <div className="mt-14 flex justify-center">
            <Link to="/contact" className="btn-primary">
              Start Your Surveillance Project <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            eyebrow="Why us"
            title={<>Why Clients Choose Roya Ventures as Their Surveillance Provider?</>}
            ...
            <Reveal>
              <div className="lg:sticky lg:top-28 space-y-5">
                <div className="group relative overflow-hidden rounded-2xl border border-white/10 shadow-[var(--shadow-elegant)]">
                  <img
                    src={survEngineer}
                    alt="Certified engineer installing a CCTV camera"
                    loading="lazy"
                    width={1280}
                    height={960}
