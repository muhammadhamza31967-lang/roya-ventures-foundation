...
import heroIt from "@/assets/it/it-hero.jpg";
import itInfrastructure from "@/assets/it/it-infrastructure.jpg";
import itServers from "@/assets/it/it-servers.jpg";
import itHardware from "@/assets/it/it-hardware.jpg";
import itCloud from "@/assets/it/it-cloud.jpg";
...
export const Route = createFileRoute("/services/it-services")({
  head: () => ({
    meta: [
      { title: "IT Services in Saudi Arabia — Roya Ventures" },
      {
        name: "description",
        content:
          "IT consulting company in Saudi Arabia — IT infrastructure setup, servers and storage, hardware procurement, cloud migration, cybersecurity and full IT outsourcing.",
      },
      { property: "og:title", content: "IT Services in Saudi Arabia — Roya Ventures" },
      {
        property: "og:description",
        content:
          "Designing, building and managing complete IT infrastructure for enterprises across Saudi Arabia and beyond.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "/services/it-services" }],
  }),
...
const OFFERINGS = [
  {
    ...
    text: "We design, deploy, and manage the physical and virtual infrastructure your business depends on.",
    image: itInfrastructure,
  },
  {
    icon: Server,
    title: "Server & Storage Solutions",
    text: "We specify, supply, and configure physical and virtual server environments on-premise, cloud, or hybrid.",
    image: itServers,
  },
  {
    icon: Laptop,
    title: "Hardware Procurement & Setup",
    text: "We procure the right hardware at competitive prices, configure everything before it arrives at your desk, and deploy it ready-to-use.",
    image: itHardware,
  },
  {
    icon: Cloud,
    title: "Cloud Services & Migration",
    text: "We plan and execute cloud migrations that minimise disruption, configure Microsoft 365, Azure, and other platforms properly, and make sure your team actually knows how to use what they've got.",
    image: itCloud,
  },
  {
    icon: ShieldCheck,
    title: "Cybersecurity & Data Protection",
    text: "We implement security, endpoint protection, email security, firewall management, access controls and security monitoring that protects your business.",
    image: itSecurity,
  },
  {
    icon: Headset,
    title: "Full IT Outsourcing",
    text: "We act as your complete IT department, such as strategy, infrastructure, support, security, licensing and backups, all handled by our team under one contract.",
    image: itOutsourcing,
  },
];
...
const FAQS: [string, string][] = [
  [
    ...
    "Yes. We regularly provide co-managed IT services by handling all functions.",
  ],
  [
    "Do you handle Microsoft 365 and cloud platform management?",
    "Yes. We manage Microsoft 365 setup, licence management, Teams configuration, SharePoint, OneDrive, Azure and other cloud platforms your business relies on.",
  ],
  [
    "We've had bad experiences with IT support before. What makes you different?",
    "The most common complaints are slow response times, fixes that don't last, and support staff who make users feel like the problem. We address all three through agreed-upon SLAs, root cause analysis, and a support team that communicates clearly and respectfully.",
  ],
  [
    "How do you handle cybersecurity for remote or hybrid teams?",
    "We implement endpoint protection, VPN, multi-factor authentication, email security, and access controls specifically designed for environments where staff work from multiple locations and devices.",
  ],
  [
  ...
  return (
    <SiteLayout transparentHeader>
      <PageHero
        ...
        title={
          <>
            IT Services in <span className="text-[var(--gold)]">Saudi Arabia</span>
          </>
        }
        subtitle="As a leading IT consulting company in Saudi Arabia, we've been designing, building, and managing complete IT infrastructure."
        image={heroIt}
        height="compact"
      >
        ...
        <div className="container-px mx-auto">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 items-start">
            <Reveal>
              ...
              <h2 className="heading-sub-lg mt-6">IT Consulting Services Overview</h2>
      ...
      <section className="section-y bg-[var(--stone)] relative overflow-hidden">
        ...
        <div className="container-px mx-auto relative">
          <SectionHeading
            ...
            title={<>What We Offer</>}
            description="Building end-to-end IT services from the hardware on your desk to the cloud your business runs on."
          />
          ...
          <div className="mt-14 flex justify-center">
            <Link to="/contact" className="btn-primary">
              Start Your IT Project <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            eyebrow="Why us"
            title={<>Why Clients Choose Roya Ventures as Their IT Services Provider?</>}
