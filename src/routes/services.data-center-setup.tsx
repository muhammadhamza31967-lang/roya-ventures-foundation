...
import heroDatacenter from "@/assets/svc-datacenter.jpg";
import dcBuild from "@/assets/dc/dc-build.jpg";
import dcUpgrade from "@/assets/dc/dc-upgrade.jpg";
import dcColocation from "@/assets/dc/dc-colocation.jpg";
import dcCooling from "@/assets/dc/dc-cooling.jpg";
import dcCabling from "@/assets/dc/dc-cabling.jpg";
import dcMonitoring from "@/assets/dc/dc-monitoring.jpg";
import dcEngineer from "@/assets/dc/dc-engineer.jpg";
import dcHall from "@/assets/dc/dc-hall.jpg";
...
export const Route = createFileRoute("/services/data-center-setup")({
  head: () => ({
    meta: [
      { title: "Data Center Setup in Saudi Arabia — Roya Ventures" },
      {
        name: "description",
        content:
          "Data center design, build and commissioning in Saudi Arabia — raised flooring, power, cooling, structured cabling, racks, DCIM and 24/7 support by certified engineers.",
      },
...
const OFFERINGS = [
  {
    icon: Server,
    title: "Build New Data Center",
    text: "We handle site assessment, capacity planning, raised flooring, power distribution, cooling design, cabling, and rack installation.",
    image: dcBuild,
  },
  {
    icon: Layers,
    title: "Data Center Upgrades & Expansion",
    text: "We upgrade and expand existing data centers without disrupting live operations.",
    image: dcUpgrade,
  },
  {
    icon: LayoutGrid,
    title: "Colocation & Rack Setup",
    text: "We design and configure colocation environments and individual rack setups to maximise density, airflow, and cable management.",
    image: dcColocation,
  },
  {
    icon: Thermometer,
    title: "Cooling & Power Infrastructure",
    text: "We design precision cooling systems and robust power infrastructure, including UPS and PDUs.",
    image: dcCooling,
  },
  {
    icon: Network,
    title: "Structured Cabling & Management",
    text: "We install structured cabling systems that are clean, colour-coded, labelled, and easy to manage.",
    image: dcCabling,
  },
  {
    icon: Activity,
    title: "Monitoring & DCIM Systems",
    text: "We implement data center infrastructure management (DCIM) and monitoring systems that give you real-time visibility into power usage, temperature, and system health.",
    image: dcMonitoring,
  },
];
...
const INDUSTRIES = [
  { icon: Building2, title: "Enterprises & Corporates" },
...
const FAQS: [string, string][] = [
  [
    "Do you handle the full project or just part of it?",
    "We handle everything from first site assessment and design to installation and long-term support.",
  ],
  [
...
function DataCenterSetupPage() {
  ...
  return (
    <SiteLayout transparentHeader>
      <PageHero
        eyebrow="Data center setup"
        title={
          <>
            Data Center Setup in <span className="text-[var(--gold)]">Saudi Arabia</span>
          </>
        }
        subtitle="We design, build, and commission data centers that run reliably and scale with your business."
        image={heroDatacenter}
        height="compact"
      >
        <Link to="/contact" className="btn-primary btn-on-dark">
          Plan Your Data Center <ArrowRight className="h-4 w-4" />
        </Link>
        ...
        <div className="container-px mx-auto">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 items-start">
            <Reveal>
              ...
              <h2 className="heading-sub-lg mt-6">Data Center Setup Overview</h2>
      ...
      <section className="section-y bg-[var(--stone)] relative overflow-hidden">
        ...
        <div className="container-px mx-auto relative">
          <SectionHeading
            ...
            title={<>What We Offer</>}
            description="We handle every component of your data center."
          />
          ...
          <div className="mt-14 flex justify-center">
            <Link to="/contact" className="btn-primary">
              Start Your Data Center Project <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="container-px mx-auto">
          <SectionHeading
            eyebrow="Why us"
            title={<>Why Clients Choose Roya Ventures</>}
            ...
            <Reveal>
              <div className="lg:sticky lg:top-28 space-y-5">
                <div className="group relative overflow-hidden rounded-2xl border border-white/10 shadow-[var(--shadow-elegant)]">
                  <img
                    src={dcEngineer}
                    alt="Certified engineer commissioning data center systems"
                    loading="lazy"
                    width={1280}
                    height={960}
            ...
            <Reveal delay={0.1}>
              <div className="relative overflow-hidden rounded-2xl border border-[var(--gold)]/30 bg-gradient-to-br from-white to-[var(--stone)] p-9 shadow-[var(--shadow-card)]">
                ...
                <p className="mt-4 text-[15px] leading-[1.75] text-muted-foreground">
                  Full data center build including power, cooling, structured cabling, and DCIM.
                </p>
