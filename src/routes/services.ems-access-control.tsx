...
import heroEms from "@/assets/svc-ems-new.jpg";
import emsDoorAccess from "@/assets/ems/ems-door-access.jpg";
import emsBiometric from "@/assets/ems/ems-biometric.jpg";
import emsIntrusion from "@/assets/ems/ems-intrusion.jpg";
import emsVisitor from "@/assets/ems/ems-visitor.jpg";
import emsBms from "@/assets/ems/ems-bms.jpg";
import emsEnergy from "@/assets/ems/ems-energy.jpg";
import emsHvac from "@/assets/ems/ems-hvac.jpg";
import emsEngineer from "@/assets/ems/ems-engineer.jpg";
...
export const Route = createFileRoute("/services/ems-access-control")({
  head: () => ({
    meta: [
      { title: "EMS and Access Control System in Saudi Arabia — Roya Ventures" },
      {
        name: "description",
        content:
          "Access control system company in Saudi Arabia — biometric systems, door and barrier access, intrusion alarms, visitor management, BMS and energy monitoring by certified engineers.",
      },
      {
        property: "og:title",
        content: "EMS and Access Control System in Saudi Arabia — Roya Ventures",
      },
      {
        property: "og:description",
        content:
          "Unified access control and energy management systems designed, installed and supported across Saudi Arabia.",
      },
...
const OFFERINGS = [
  {
    icon: DoorOpen,
    title: "Door & Barrier Access Control",
    text: "We design and install electronic access control across doors, barriers and gates.",
    image: emsDoorAccess,
  },
  {
    icon: Fingerprint,
    title: "Biometric Systems",
    text: "We provide fingerprint and facial recognition systems that verify identity accurately.",
    image: emsBiometric,
  },
  {
    icon: ShieldAlert,
    title: "Intrusion Detection & Alarm Systems",
    text: "We develop intrusion detection systems, motion sensors, door contacts, glass break detectors, and perimeter alarms.",
    image: emsIntrusion,
  },
  {
    icon: UserCheck,
    title: "Visitor Management Systems",
    text: "We implement digital visitor management systems that pre-register guests, issue temporary access credentials, and log arrival and departure times.",
    image: emsVisitor,
  },
  {
    icon: LayoutDashboard,
    title: "Building Management System (BMS)",
    text: "We build BMS platforms that give your facilities team real visibility and real control.",
    image: emsBms,
  },
  {
    icon: Gauge,
    title: "Energy Monitoring & Control",
    text: "We install energy monitoring systems that track consumption across your facility in real time.",
    image: emsEnergy,
  },
  {
    icon: Thermometer,
    title: "HVAC & Lighting Automation",
    text: "We automate HVAC and lighting control based on occupancy, schedules and environmental conditions.",
    image: emsHvac,
  },
];
...
const FAQS: [string, string][] = [
  [
    "Can you work with our existing access control system?",
    "Yes. We'll assess what you have, tell you upfront whether it's worth integrating or replacing.",
  ],
  [
    "What happens to access records if the system goes offline?",
    "We design systems with local storage so that access events continue to be logged even during a network outage.",
  ],
  [
    "Do you provide training for our team?",
    "Yes. Every project includes a handover training session for your facilities and security teams.",
  ],
  [
    "Can access control and energy management really be integrated?",
    "Yes. When your BMS knows who's in which zone, it can automatically adjust lighting and HVAC in real time. We design these integrations from the start so they work seamlessly.",
  ],
  [
        ...
        <div className="container-px mx-auto">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 items-start">
            <Reveal>
              ...
              <h2 className="heading-sub-lg mt-6">EMS and Access Control System Overview</h2>
      ...
      <section className="section-y bg-[var(--stone)] relative overflow-hidden">
        ...
        <div className="container-px mx-auto relative">
          <SectionHeading
            ...
            title={<>What We Offer</>}
            description="We deliver from a single secured entrance to a fully integrated smart building, covering your entire infrastructure."
          />
          ...
          <div className="mt-14 flex justify-center">
            <Link to="/contact" className="btn-primary">
              Start Your EMS &amp; Access Control Project <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
            ...
            <Reveal>
              <div className="lg:sticky lg:top-28 space-y-5">
                <div className="group relative overflow-hidden rounded-2xl border border-white/10 shadow-[var(--shadow-elegant)]">
                  <img
                    src={emsEngineer}
                    alt="Certified engineer configuring an access control panel"
                    loading="lazy"
                    width={1280}
                    height={960}
