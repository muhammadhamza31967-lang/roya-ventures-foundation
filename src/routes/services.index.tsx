            ...
            {SERVICES.map((s, i) => {
              ...
              return (
                <Reveal key={s.slug} delay={(i % 3) * 0.08}>
                  ...
                  ) : s.slug === "data-center-setup" ? (
                    <Link
                      to="/services/data-center-setup"
                      className="block h-full"
                      aria-label={`${s.title} — view service details`}
                    >
                      {card}
                  ...
                  ) : s.slug === "fire-fighting" ? (
                    <Link
                      to="/services/fire-fighting"
                      className="block h-full"
                      aria-label={`${s.title} — view service details`}
                    >
                      {card}
                  ...
                  ) : s.slug === "surveillance-system" ? (
                    <Link
                      to="/services/surveillance-system"
                      className="block h-full"
                      aria-label={`${s.title} — view service details`}
                    >
                      {card}
                    </Link>
                  ) : s.slug === "digital-signage-ink-displays" ? (
                    <Link
                      to="/services/digital-signage-ink-displays"
                      className="block h-full"
                      aria-label={`${s.title} — view service details`}
                    >
                      {card}
                    </Link>
                  ) : s.slug === "pos-hardware-software" ? (
                    <Link
                      to="/services/pos-hardware-software"
                      className="block h-full"
                      aria-label={`${s.title} — view service details`}
                    >
                      {card}
                  ...
                  ) : s.slug === "ethernet-fiber-cabling" ? (
                    <Link
                      to="/services/ethernet-fiber-cabling"
                      className="block h-full"
                      aria-label={`${s.title} — view service details`}
                    >
                      {card}
                    </Link>
                  ) : s.slug === "integrated-facility-management" ? (
                    <Link
                      to="/services/integrated-facility-management"
                      className="block h-full"
                      aria-label={`${s.title} — view service details`}
                    >
                      {card}
