      ...
      <div className="container-px mx-auto relative">
        ...
        <div className="grid gap-12 md:gap-x-10 lg:gap-x-16 xl:gap-x-20 md:grid-cols-2 lg:grid-cols-12 pt-16 pb-12">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="inline-flex items-center gap-6 md:gap-8 rounded-2xl bg-white/95 px-6 py-4 shadow-lg ring-1 ring-white/20">
              <img
                src={logo.url}
                alt="Roya Ventures"
                ...
                loading="lazy"
              />
              <span aria-hidden className="h-14 md:h-16 w-px bg-[var(--navy)]/15" />
              <img
                src={visionLogo.url}
